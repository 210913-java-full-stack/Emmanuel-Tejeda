...
public class CreatingFlights {
    ...
    public List<Flight> flightsList(){
        ...
        String [] listOfDepartingCities =  {"Providence", "Los Baños", "Piñon Hills", "Tfuna" +
                "Lumā", "Arnesén"};
        ...
        flight3.setFlightID(2);
        flight3.setStartingCity(listOfDepartingCities[2]);
        flight3.setLandingCity(listOfArrivalCities[2]);

        flight4.setFlightID(4);
        flight4.setStartingCity(listOfDepartingCities[4]);
        flight4.setLandingCity(listOfArrivalCities[4]);
